...
for i = 1: size(assignments, 1)
	alleles = assignments(i, 2:3);
	genotype = allelesToGenotypes(alleles(1), alleles(2));
	if(assignments(i, 1) == 1)
		phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assignments(i, :), alphaList(genotype))
	else
		phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assignments(i, :), 1- alphaList(genotype))
	end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%